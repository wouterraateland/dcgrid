...
inline __host__ __device__ int2 xy(const int3& a) {
  return make_int2(a.x, a.y);
}
inline __host__ __device__ int2 xz(const int3& a) {
  return make_int2(a.x, a.z);
}
inline __host__ __device__ int2 yz(const int3& a) {
  return make_int2(a.y, a.z);
}

inline __host__ __device__ float2 xy(const float3& a) {
  return make_float2(a.x, a.y);
}
inline __host__ __device__ float2 xz(const float3& a) {
  return make_float2(a.x, a.z);
}
inline __host__ __device__ float2 yz(const float3& a) {
  return make_float2(a.y, a.z);
}
